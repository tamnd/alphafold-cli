...
```
alphafold <command> [arguments] [flags]
```

Run `alphafold <command> --help` for the full flag list on any command. This
...
per operation you declare in `alphafold/domain.go`.
