...
Most of these come down to network reality or how alphafold serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

alphafold rate-limits like any public site. alphafold already paces
...
Where a surface is gated, alphafold reads a cookie or token you supply
...
`alphafold`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what alphafold actually did
